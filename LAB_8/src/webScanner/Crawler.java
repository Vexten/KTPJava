...
public class Crawler implements Runnable {
	...
	/** Поле DBManager'а, к которому привязан Crawler */
	private DBManager manager;
	
	/** Поле пула ссылок, к которому привязан Crawler */
	 ...
	 * @param pool - URLPool для привязки.
	 * @param timeout - Время ожидания сокета.
	 */
	public Crawler(DBManager mng, URLPool pool, int timeout) {
		this.manager = mng;
		this.pool = pool;
	...
	private void grabAndParse() {
		try {
			...
			this.io.setSoTimeout(this.timeout);
