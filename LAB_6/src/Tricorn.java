...
/**
 * Класс, управляющий расчетом и начальным отображением фрактала Мандельбара
 * @author niksh
 *
 */
public class Tricorn extends FractalGenerator {
	...
	/**
	 * Итеративная формула расчета принадлежности точки к множеству Мандельбара
